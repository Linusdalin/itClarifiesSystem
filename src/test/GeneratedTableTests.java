...
;            bo.init();
         ...
         public void testContractFragment(){
             ...
             try{
                 ...
                 contractManagement.ContractFragment table1 = new contractManagement.ContractFragment("text 1", dummyKey, dummyKey, 4, 5, "text 6", 7, "text 8", new risk.ContractRiskTable().getDummyConstantValue( ), 10, 11, 12, 13, 14, 15, "text 16");
