        ...
        try {
         ...
         public void testRiskClassification(){
             ...
             try{
                 ...
                 risk.RiskClassification table1 = new risk.RiskClassification(dummyKey, dummyKey, "text 3", "text 4", dummyKey, dummyKey, dummyKey, "text 8", 9, "2012-01-10");
         ...
         public void testReclassification(){
             ...
             try{
                 ...
                 contractManagement.Reclassification table1 = new contractManagement.Reclassification("text 1", false, dummyKey, "text 4", "text 5", 6, "text 7", "text 8", "text 9", 10, 11, dummyKey, dummyKey, "2012-01-14", true);
