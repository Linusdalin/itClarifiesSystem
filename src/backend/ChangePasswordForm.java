...
public class ChangePasswordForm extends Form implements FormInterface {

    public ChangePasswordForm(BackOfficeInterface bo, String section, String list, PortalUser user){
        ...
        try {
            ...
            elements.add(new TableField("Organization", "Organization", new OrganizationTable(), user.getOrganizationId()));
