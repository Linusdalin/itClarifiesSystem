    ...
    public String submitCallBack(HttpServletRequest request, BackOfficeInterface backOffice) throws BackOfficeException {
        ...
        try {
            ...
            if(!fragment.exists()){
                ...
                FragmentClassification definitionSource = new FragmentClassification(fragment, tag, 80, 0, FragmentClassification.GENERATED, "", "",  user, version, project, pattern, patternPos, pattern.length(), 100, keyWords, now.getISODate());
