...
public class ActionList extends GroupByList implements ListInterface{


    public static final String Name = "ActionList";
    public static final String Title = "All Actions";
    public static final String Description = "All actions in the system grouped by project.";
    public static final int GroupColumn = 7; // Group by Project
    ...
    private static final DataTableInterface table = new ActionTable();


    public ActionList(BackOfficeInterface backOffice){
        ...
        setSorting(new Sorting(ActionTable.Columns.Version.name(), Ordering.FIRST));   //Ordered by version
    ...
    public String callBack(int action, DBKeyInterface key, String section, HttpServletRequest request){
        ...
        Action theAction  = new Action(new LookupByKey(key));
