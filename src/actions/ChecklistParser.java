...
public class ChecklistParser {
    ...
    public void mapItemSources(List<ContractFragment> documentFragments){
        ...
        for (ContractFragment documentFragment : documentFragments) {
            ...
            for (SourceMap map : sourceMap) {
                ...
                ChecklistItem item = new ChecklistItem(new LookupByKey(map.checklistItem));
        ...
        try{
            ...
            if(cellInfo == null){
                ...
                if(cellInfo.row > 2 && cellInfo.col == 0){
                    ...
                    feedback = storeChecklistItem(cellInfo.row);
    ...
    public AnalysisFeedbackItem storeChecklistItem(int row){
    ...
    private class SourceMap {
        ...
        protected final DBKeyInterface checklistItem;
