...
public class ContractFragmentTable extends DataTable implements DataTableInterface{
    ...
    public enum Columns {Name, Version, Project, StructureNo, Ordinal, Text, Indentation, Type, Risk, AnnotationCount, ReferenceCount, ClassificatonCount, ActionCount, xPos, yPos, width, display, }
