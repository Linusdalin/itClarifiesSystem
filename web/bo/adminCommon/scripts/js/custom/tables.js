jQuery(document).ready(function(){
	...
	jQuery('.stdtable a.execute').click(function(){
		var c = confirm('Continue Execute?');
    ...
    // Linus: Quick fix changing from live to on. What should the second argument be?
		
	jQuery('.toggledata button.cancel, .toggledata button.submit').on('click', '.toggledata button.submit', function(){
    ...
    /*
            ...
            Moved to the table script generation to include starting point and ordering
